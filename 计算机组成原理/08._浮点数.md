...
![image](https://piachh.cn/show?pic=pics/float_ieee.png)
　　
...
![image](https://piachh.cn/show?pic=pics/float32.png)

## 64位(double/float64)
> 对于64位的浮点数，最高的1位是符号位S，接着的11位是指数E，剩下的52位为有效数字M。

![image](https://piachh.cn/show?pic=pics/float64.png)
...
![image](https://piachh.cn/show?pic=pics/float_plus.jpg)
